// src/components/tile/images/rotate/index.ts
// Import SVGs as React components using ?react query
...
import m0 from './0m.svg?react'; // Red five
...
import p0 from './0p.svg?react'; // Red five
...
import s0 from './0s.svg?react'; // Red five
...
export const rotateTileImage = (tile: Tile) => {
  switch (tile.type) {
    case 'm':
      switch (tile.n) {
        case 1:
