...
export const tileAvailableCount = (
  red: Rule['red'],
  existing: Tile[], // this is allInputTiles from lib/result.ts
  toUse: Tile       // The tile we're checking availability for
): number | null => {
...
/* man:  0  1  2  3  4  5  6  7  8    (1m-9m)
   pin:  9 10 11 12 13 14 15 16 17    (1p-9p)
   sou: 18 19 20 21 22 23 24 25 26    (1s-9s) 
   hon: 27 28 29 30 31 32 33          (1z-7z) */
